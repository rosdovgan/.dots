{
  ...
  programs.rofi = {
    ...
    in {
      "*" = with colors.cssHex; {
        lightblack = mkLiteral blackT12;
        red = mkLiteral neutralRed;
        green = mkLiteral neutralGreen;
        blue = mkLiteral neutralBlue;
        lightblue = mkLiteral lightBlue;
        black = mkLiteral black;
        darkblack = mkLiteral blackT10;
